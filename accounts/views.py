...
from django.http import HttpResponseRedirect, HttpResponseForbidden, HttpRequest, HttpResponse
...
def account_result(request):
    ...
    if account_type and account_type in ['register', 'validation']:
...
class ForgetPasswordView(FormView):
    ...
    def form_valid(self, form):
        if form.is_valid():
            blog_user = BlogUser.objects.filter(email=form.cleaned_data["email"]).get()
